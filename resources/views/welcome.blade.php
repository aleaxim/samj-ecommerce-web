        ...
        <div class="row align-items-center">
            <div id="myCarousel" class="carousel slide" data-ride="carousel">
                ...
                <ol class="carousel-indicators">
                    <?php
                    $imagePaths = ['../images/img 3.jpg', '../images/img 2.jpg', '../images/img 5.jpg']; // Update with the actual image paths
            ...
            <section class="banner" style="margin:5em;">
                ...
                <div class="button-group d-flex justify-content-center flex-wrap">
                    <a href="#" class="main-btn primary-btn btn-hover w-auto text-center"
                        style="padding: 10px; font-size:1.3em; background-color: #2d32cd; text-align:center;">Shop Now!</a>
                </div>
            </section>
